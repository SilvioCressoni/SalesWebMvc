...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Jubileu da silva", "jubileu@gmail.com", new DateTime(1990, 1, 10), 1500.0, d1);
            Seller s2 = new Seller(2, "Catarina Brito", "cabrito@gmail.com", new DateTime(1989, 6, 24), 1700.0, d3);
            Seller s3 = new Seller(3, "Gumercindo Alves", "gumeralves@gmail.com", new DateTime(1985, 3, 17), 1450.0, d2);
            Seller s4 = new Seller(4, "Maria Odete", "mariodete@gmail.com", new DateTime(1982, 10, 03), 1800.0, d4);
            Seller s5 = new Seller(5, "Amarildo Costa", "amarcosta@gmail.com", new DateTime(1984, 12, 21), 1600.0, d2);
            Seller s6 = new Seller(6, "Jurema Aparecida", "jurecida@gmail.com", new DateTime(1987, 2, 11), 1550.0, d1);
